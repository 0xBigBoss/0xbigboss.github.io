---
title: How I Contributed to Ghostty with No Terminal Developer Experience
description: 4 crash bugs fixed with zero terminal development experience. AI tutoring + human humility = real contributions.
date: "2026-01-02"
---
...
![Mitchell's X post about AI-assisted contributions](/images/ghostty/screenshot-x-mitchellh-post.png)
...
![Discord help thread - reporting random crashes](/images/ghostty/screenshot-discord-1-help-thread.png)
...
![Discord - first patch submitted with AI transparency](/images/ghostty/screenshot-discord-2-first-patch-submitted-bigboss-intro.png)
...
![Discord - two more patches and skill share](/images/ghostty/screenshot-discord-3-bigboss-finds-2-more-patches.png)
...
![Discord - final bug caught after a month](/images/ghostty/screenshot-discord-4-patch-4-submitted.png)
...
The [crash triage skill](https://github.com/0xbigboss/ghostty-crash-triage) systematized this. Same structured investigation pattern, every time. Repeatable.
...
- [ghostty-crash-triage](https://github.com/0xbigboss/ghostty-crash-triage) - The Claude Code skill I built and shared with the Ghostty community
